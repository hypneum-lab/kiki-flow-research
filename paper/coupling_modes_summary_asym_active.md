...
Runtime: 214.4 s.  Best (lowest H) dell-full cell: alpha=10.0, beta=1.0.
...
| dell-full | 1.9753 | 0.0237 |
| symmetric-levelt | 1.9687 | 0.0240 |
| levelt-full | 1.9775 | 0.0239 |

## Comparisons

- separable vs dell-full: Delta H = -0.0142 bits (-0.72%).
- separable vs levelt-full: Delta H = -0.0164 bits.
- symmetric-dell vs dell-full: Delta H = -0.0078 bits (tests whether J_asym drift matters in the solver path).
- symmetric-levelt vs levelt-full: Delta H = -0.0088 bits.
- dell-full vs levelt-full: Delta H = -0.0022 bits (tests whether coupling topology matters).
